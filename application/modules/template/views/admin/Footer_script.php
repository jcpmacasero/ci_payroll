...
<script type="text/javascript" src="<?= base_url('assets/plugins/metisMenu/jquery.metisMenu.js'); ?>"></script>
...
<script type="text/javascript" src="<?= base_url('assets/plugins/jquery/jquery.form.min.js');?>"></script>
...
<script type="text/javascript" src="<?= base_url('assets/plugins/bootstrap-validator-master/dist/validator.min.js'); ?>"></script>
<script type="text/javascript" src="<?= base_url('assets/plugins/craftpip/dist/jquery-confirm.min.js'); ?>"></script>
...
<script type="text/javascript" src="<?= base_url('assets/plugins/datapicker/bootstrap-datepicker.js'); ?>"></script>
<script type="text/javascript" src="<?= base_url('assets/plugins/clockpicker/mdtimepicker.min.js'); ?>"></script>
<?php if ($datatable_script): ?>
	...
	<script type="text/javascript" src="<?= base_url('assets/plugins/dataTables/dataTables.responsive.js'); ?>"></script>
	<script type="text/javascript" src="<?= base_url('assets/plugins/dataTables/dataTables.tableTools.min.js'); ?>"></script>
...
<?php if ($file_drop_script): ?>
	...
	<script type="text/javascript" src="<?= base_url('assets/plugins/codemirror/codemirror.js'); ?>"></script>
	<script type="text/javascript" src="<?= base_url('assets/plugins/codemirror/xml.js'); ?>"></script>	
<?php endif ?>

<script type="text/javascript" src="<?= base_url('assets/plugins/admin_style_default/inspinia.js'); ?>"></script>
<script type="text/javascript" src="<?= base_url('assets/plugins/pace/pace.min.js'); ?>"></script>
<script type="text/javascript" src="<?= base_url('assets/js/common/custom.js'); ?>"></script>