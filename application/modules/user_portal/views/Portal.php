   ...
   <div class="row">
        ...
        <div class="col-sm-4">
            <div class="account-box animated fadeInDown">
                ...
                <?= form_open(base_url("user_request_login")); ?>
                ...
                <div class="text-center">
                    <br>
                    <p class="text-muted text-center">Do not have an account? Contact Administrator</p>
                    <br>
                    <a class="forgotLnk" href="#modal_contact_admin" data-toggle="modal">I can't access my account</a>
                    <p class="m-t-lg">&copy; <?= company_name; ?> <?= date("Y") ?></p>
                </div>
            </div>
        </div>
    </div>
